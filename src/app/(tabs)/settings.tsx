...
import { useOutputDevicesStore, DEVICE_CATEGORIES, startDeviceDetection } from '@/store/output-devices-store';
          ...
          <Section title="OUTPUT DEVICES" colors={colors}>
            {DEVICE_CATEGORIES.map((cat, idx) => {
              const categoryIcon: Record<string, any> = {
                ...
                return (
                  <View key={cat.key}>
                    <View style={[s.flexRow, s.itemsCenter, s.gap4, s.p4, s.mt2]}>
                      <View style={[s.w10, s.h10, s.roundedXl, s.itemsCenter, s.justifyCenter, { backgroundColor: colors.accent + '15' }]}>

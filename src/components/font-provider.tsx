...
const FONT_MAP: Record<string, () => Promise<void>> = {
  system: async () => {},
  serif: async () => {
    await Font.loadAsync({ 'PlayfairDisplay': require('../../assets/fonts/PlayfairDisplay-Regular.ttf') });
  },
  rounded: async () => {
    await Font.loadAsync({ 'Nunito': require('../../assets/fonts/Nunito-Regular.ttf') });
  },
  mono: async () => {
    await Font.loadAsync({ 'JetBrainsMono': require('../../assets/fonts/JetBrainsMono-Regular.ttf') });
  },
  poppins: async () => {
